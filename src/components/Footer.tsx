...
const AboutUs = () => {
  return (
    <div className="footer-column invisible md:visible absolute md:static">
...
const QuickLinks = () => {
  return (
    <div className="footer-column text-left md:text-center">
      <h3 className="text-lg font-bold mb-4">Quick Links</h3>
      <ul className="list-none flex flex-col items-start md:items-center justify-center">
        <li className="mb-2">
          <a href="#">
            <FacebookIcon />
          </a>
...
// Social Media Icons (you can replace these with SVG components or images)
const FacebookIcon = () => (
