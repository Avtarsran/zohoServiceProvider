...
const ContactForm: React.FC = () => {
    ...
    return (
        <div
            ref={formRef}
            className="bg-[#d3d6db] contactForm rounded-lg px-2 py-3 m-2 opacity-0 transform translate-y-5 transition-all duration-1000 ease-in"
            ...
            <form className="w-full px-5" onSubmit={handleSubmit}>
                <div className="flex justify-between">
                    <div className="form-group mb-1.5">
                        ...
                        <input type="text" id="name" name="name" className="p-1 mx-1 border border-gray-400 rounded" />
                    </div>
                    <div className="form-group mb-1.5">
                        <label htmlFor="email" className="block text-lg mb-1">Email:</label>
                        <input type="email" id="email" name="email" className="p-1 border border-gray-400 rounded" />
                    </div>
                </div>
                ...
                <div className="flex justify-evenly">
                    <div className="form-group mb-1.5">
                        ...
                        <input type="text" id="company" name="company" className="p-1 mx-1 border border-gray-400 rounded" />
                    </div>
                    <div className="form-group mb-1.5">
                        <label htmlFor="website" className="block text-lg mb-1">Website:</label>
                        <input type="url" id="website" name="website" className="p-1 border border-gray-400 rounded" />
                    </div>
                </div>
