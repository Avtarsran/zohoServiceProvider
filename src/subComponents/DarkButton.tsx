...
const DarkButton = ({ buttonText, toLink, aTag, lgScreen }: button) => {
  return (
    <div className={`cursor-pointer w-full sm:w-auto md:w-auto lg:w-auto border-4 ${lgScreen?"invisible lg:visible absolute lg:static":""}  rounded-xl border-transparent transition ease-in-out delay-150 hover:border-red-200 hover:bg-red-700 duration-150`}>
