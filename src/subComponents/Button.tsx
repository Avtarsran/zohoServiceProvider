...
const Button = ({buttonText,toLink, aTag}:button) => {
  return (
    <div>
      <div className="border w-44 lg:w-auto rounded-lg border-white transition ease-in-out delay-150 hover:border-red-500 hover:shadow-[0px_0px_0px_3px_rgb(99.6%,79.2%,79.2%)] duration-150">
